$(document).ready(function () {
    ...
    $("#main-form").submit(function(event){
        ...
        console.log(logo);  console.log( company_tagline); console.log( phone ); console.log(cover_unsplash); console.log( cover_upload); console.log( insured); console.log( bonded); console.log( emergency); console.log( veteran); console.log( family); console.log( local); console.log( license); console.log(
